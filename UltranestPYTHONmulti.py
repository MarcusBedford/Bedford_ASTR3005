...
def UltranestMSTO(sobjectIDs):
    ...
    for sobjectID in sobjectIDs:
        starnum = (galah_dr4_raw["sobject_id"]==sobjectID)
        star = galah_dr4_raw[starnum][0]
        ####################################################
        ...
        sampler = ultranest.ReactiveNestedSampler(param_names, my_likelihood, my_prior_transform, log_dir="MSTOStarResults/"+str(sobjectID), resume='overwrite')
